...
KERNEL_BOOTIMAGE_CMDLINE = androidboot.memcg=1 console=tty0 earlycon=msm_geni_serial,0xA84000 androidboot.hardware=qcom 
androidboot.console=ttyMSM0 video=vfb:640x400,bpp=32,memsize=3072000 msm_rtb.filter=0x237 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 service_locator.enable=1 swiotlb=2048 androidboot.configfs=true loop.max_part=7 androidboot.usbcontroller=a600000.dwc3 apparmor=1 security=apparmor systemd.unified_cgroup_hierarchy=0 droidian.lvm.noresize luks.cust.dev=/dev/mmcblk0p4
...
KERNEL_CONFIG_EXTRA_FRAGMENTS = beryllium-halium.config container.config beryllium-droidian.config #beryllium-optimizations.config #vayu-halium-lxc.config vayu-halium-net.config vayu-halium-security.config
...
KERNEL_CONFIG_DEBUG_FRAGMENTS = beryllium-debug.config #common_fragments/debug.config
...
KERNEL_BOOTIMAGE_PAGE_SIZE = 0x1000
KERNEL_BOOTIMAGE_BASE_OFFSET = 0x00000000
KERNEL_BOOTIMAGE_KERNEL_OFFSET = 0x8000
KERNEL_BOOTIMAGE_INITRAMFS_OFFSET = 0x1000000
